...
function DrawingArea(_a) {
    ...
    function renderStroke(stroke) {
        ...
        ctx.lineCap = "round";
        ctx.beginPath();
        if (stroke.smoothing === exports.EnumSmoothLevel.ADVANCED) {
            curve.lineStart();
        ...
        else if (stroke.smoothing === exports.EnumSmoothLevel.BASIC) {
    ...
    var handler = {
        ...
        /** @param {TouchEvent} e */
        ontouchstart: function (e) { return handleTouchEvent(drawStartHandler, e); },
        onmousemove: drawHandler,
        /** @param {TouchEvent} e */
        ontouchmove: function (e) { return handleTouchEvent(drawHandler, e); },
        onmouseup: drawStopHandler,
        /** @param {TouchEvent} e */
        ontouchend: function (e) { return handleTouchEvent(drawStopHandler, e); }
    };
